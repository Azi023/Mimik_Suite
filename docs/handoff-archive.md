# HANDOFF ARCHIVE — Mimik Suite

> Cold storage for HANDOFF.md. Entries from 2026-07-25 pm14 and earlier, newest first.
> Live state lives in `HANDOFF.md` at the repo root — read that first. This file is
> history only: search it when a live entry references a decision you cannot find.
